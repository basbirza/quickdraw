...
<head>
    ...
    <title>Shipping Labels - {{ $orders->count() }} Orders</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="print-info no-print">
        <strong>📦 {{ $orders->count() }} Labels Ready</strong><br>
        <span style="font-size: 12px; color: #666;">Each label will print on a separate page</span>
    </div>

    <button onclick="window.print()" class="print-button no-print">🖨️ Print All Labels</button>
